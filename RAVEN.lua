...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "XUaXU")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@EEEEEL")  
...
local list = database:smembers(bot_id.."RAVEN1:List:Filter"..sl)
...
usertext = '*\n ✫︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'XUaXU')..')'
status  = '\n *✫︙تم ترقيته مطور*'
...
usertext = '\n *✫︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XUaXU')..')'
status  = '\n*✫︙تم ترقيته مطور*'
...
if RAVEN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XUaXU')..') \n ✫︙'..RAVEN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/XUaXU)}\n✫︙["..RAVEN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝘳𝘢𝘷𝘦𝘯\n\n[✫  𝘳𝘢𝘷𝘦𝘯 ᴄʜᴀɴɴᴇʟ](http://t.me/XUaXU)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/RaVeNFiles)\n\n[✫  𝘳𝘢𝘷𝘦𝘯 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/EEEEEL)\n\n[✫  ʙᴏᴛ 𝘳𝘢𝘷𝘦𝘯](http://t.me/mw_mBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ sᴏᴜʀᴄʀ 𝘳𝘢𝘷𝘦𝘯',url="t.me/XUaXU/23"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XUaXU&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*✫︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XUaXU')..') \n*✫︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XUaXU')..') \n*✫︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
local UserName = (b.username_ or "XUaXU")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'XUaXU')..')'
status  = '\n*✫︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XUaXU')..')'
status  = '\n*✫︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✫︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XUaXU')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✫︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'XUaXU')..')'..'\n*✫︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'RaVeNFiles')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XUaXU')..')'
local iduser = result.sender_user_id_

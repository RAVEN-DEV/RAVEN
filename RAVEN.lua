...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./RAVEN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("RN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S RAVEN -X kill
screen -S RAVEN ./RAVEN
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RAVEN-DEV/File_Raven/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAVENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "XQJXQ")
...
local RAVEN_Msg = ''  
if msgs < 100 then 
RAVEN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
RAVEN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
RAVEN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
RAVEN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
RAVEN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RAVEN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RAVEN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RAVEN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RAVEN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RAVEN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RAVEN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RAVEN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RAVEN_Msg = 'رب التفاعل'  
end 
return RAVEN_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@PHPHb")  
...
--------------------------------------------------------------------------------------------------------------
function SourceRAVEN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
SourceRAVENr = '*✫︙اهلا عزيزي*\n*✫︙انا بوت اسمي '..Namebot..'*\n*✫︙اختصاصي حمايه الكروبات*\n*✫︙من تكرار والسبام والتوجيه والخ…*\n*✫︙لتفعيلي اتبع الاخطوات…↓*\n*✫︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n✫︙[قناة سورس البوت](http://t.me/XQJXQ)'
end
send(msg.chat_id_, msg.id_, SourceRAVENr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevRAVENW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRAVENW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,RAVEN_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✫' and DevRAVENW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevRAVENW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevRAVENW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevRAVENW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevRAVENW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevRAVENW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevRAVENW(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫︙[تحديثات البوت](t.me/XQCXQ) \n✫︙[قناه السورس](t.me/XQJXQ)')
end
if text == "ضع اسم للبوت ✫" and DevRAVENW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and DevRAVENW(msg) then 
...
if text == 'المشتركين ✫' and DevRAVENW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevRAVENW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevRAVENW(msg) then
...
if text == ("قائمه العام ✫") and DevRAVENW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevRAVENW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevRAVENW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevRAVENW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevRAVENW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevRAVENW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevRAVENW(msg) then 
...
if text == "تنظيف المشتركين ✫" and DevRAVENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and DevRAVENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*✫︙عدد الكروبات الان » { '..#group..' }'..RAVENk..''..RAVEN..'*\n*✫︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRAVENW(msg) then
...
usertext = '*\n ✫︙العضو »* ['..result.title_..'](t.me/'..(username or 'XQJXQ')..')'
status  = '\n *✫︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevRAVENW(msg) then
...
usertext = '\n *✫︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XQJXQ')..')'
status  = '\n*✫︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRAVENW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRAVENW(msg) then
...
local RAVEN1_Msg = database:get(bot_id.."RAVEN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RAVEN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XQJXQ')..') \n ✫︙'..RAVEN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if RAVEN_Msg and not Special(msg) then  
local RAVEN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RAVEN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..RAVEN_Msg.."] \n")
else
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/XQJXQ)}\n✫︙["..RAVEN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *✫︙عذرا »* {["..data.first_name_.."](T.ME/XQJXQ)}\n*✫︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRAVENW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRAVENW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRAVENW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRAVENW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevRAVENW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevRAVENW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevRAVENW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevRAVENW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevRAVENW(msg) then  
...
database:sadd(bot_id.."RAVEN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RAVEN:blocname"..msg.chat_id_)
...
function PHPHb_name(t1,t2)
if t2.id_ then 
name_RAVEN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RAVEN then 
names_RAVEN = database:smembers(bot_id.."RAVEN:blocname"..msg.chat_id_) or ""
if names_RAVEN and names_RAVEN[1] then 
for i=1,#names_RAVEN do 
if name_RAVEN:match("(.*)("..names_RAVEN[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, PHPHb_name)
end
...
database:set(bot_id.."RAVEN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RAVEN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RAVEN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RAVEN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RAVEN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RAVENa_new(RAVEN1,RAVEN2)
if RAVEN2 and RAVEN2.first_name_ then 
if RAVEN2.first_name_:match("(.*)"..database:get(bot_id.."RAVEN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RAVEN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RAVEN_nnn = database:get(bot_id.."RAVEN:nump"..msg.chat_id_) or 5
local RAVEN_nnn2 = database:get(bot_id.."RAVEN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RAVEN_nnn2) == tonumber(RAVEN_nnn) or tonumber(RAVEN_nnn2) > tonumber(RAVEN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RAVEN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫︙عزيزي >>["..RAVEN2.username_.."](https://t.me/"..(RAVEN2.username_ or "XQJXQ")..")\n✫︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RAVEN:teh"..msg.chat_id_).."} بجانب اسمك\n✫︙عدد المحاولات المتبقيه {"..(tonumber(RAVEN_nnn) - tonumber(RAVEN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RAVENa_new)
end
end
...
local RAVENChengName = database:get(bot_id.."RAVEN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RAVENChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RAVENChengName..']')
database:del(bot_id.."RAVEN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RAVENChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."RAVEN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RAVENChengUserName = database:get(bot_id.."RAVEN:Cheng:UserName"..data.id_)
if not data.username_ then 
if RAVENChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RAVENChengUserName..']')
database:del(bot_id.."RAVEN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RAVENChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RAVEN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RAVENChengPhoto = database:get(bot_id.."RAVEN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RAVENChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RAVEN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RAVENChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RAVEN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [𝗥𝗮𝗩𝗲𝗡 𝗥𝗡𝗔𝗠💘](t.me/XQCXQ)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/XQCXQ"},
},
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/XQCXQ/3"},
},
{
{text = 'تواصل السوࢪس 💘',url="t.me/Y3XIBOT"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/PHPHb"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevRAVENW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *✫︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XQJXQ')..') \n*✫︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XQJXQ')..') \n*✫︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevRAVENW(msg) then    
dofile('RAVEN.lua')  
send(msg.chat_id_, msg.id_, ' *✫︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRAVENW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRAVENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevRAVENW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevRAVENW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRAVENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevRAVENW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevRAVENW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRAVENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevRAVENW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevRAVENW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevRAVENW(msg) then
...
if database:get(bot_id.."PHPHb:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'PHPHb:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevRAVENW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RAVEN-DEV/File_Raven/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRAVENW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RAVEN-DEV/File_Raven/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRAVENW(msg) then
...
if text == "مسح الملفات" and DevRAVENW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRAVENW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRAVENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "XQJXQ")
...
function Function_RAVEN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RAVEN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RAVEN, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XQJXQ')..')'
status  = '\n*✫︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✫︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'XQJXQ')..')'
...
database:set(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RAVEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RAVEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RAVEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RAVEN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RAVEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫︙ارسل الكلمه الان*")  
database:set(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAVEN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RAVEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RAVEN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RAVEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAVEN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RAVEN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *✫︙قائمة المنع* \n*•━━━━━━ 𝗥𝗡 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local RAVEN_Msg = database:get(bot_id.."RAVEN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..RAVEN_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevRAVENW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRAVENW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✫︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'XQJXQ')..')'..'\n*✫︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevRAVENW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRAVENW(msg) then  
...
if not database:get(bot_id..'PHPHb:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'PHPHb:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..RAVEN_Msg[math.random(#RAVEN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRAVENW(msg) then 
...
if text == ("مسح ردود المطور") and DevRAVENW(msg) then 
...
if text == ("ردود المطور") and DevRAVENW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n *✫︙قائمة ردود المطور* \n*•━━━━━━ 𝗥𝗡 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRAVENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevRAVENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevRAVENW(msg) then   
...
if text == 'تعطيل المغادره' and DevRAVENW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✫︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RAVEN')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XQJXQ')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
RAVENdx(msg.chat_id_, msg.id_, ' *✫︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRAVENW(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗥𝗮𝗩𝗲𝗡 𝗥𝗡𝗔𝗠.',url="t.me/XQCXQ"}},
}
local msg_id = msg.id_/2097152/0.5
...
RAVEN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RAVEN)
...
------------------------------------------------------------------------
local RAVENAbot = database:get(bot_id.."RAVEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAVENAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..RAVENAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RAVEN1_Msg = database:get(bot_id.."RAVEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAVEN1_Msg then    
send(msg.chat_id_, msg.id_," ✫︙"..RAVEN1_Msg)
